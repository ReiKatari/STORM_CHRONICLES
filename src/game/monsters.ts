...
export const FAMILIES: FamilyDef[] = [
  ...
  { id: 'necromancer',     name: 'Некромант',         icons: ['💀', '🧙‍♂️', '📜', '🕯️', '🩸', '🔮', '👑', '🟣', '🌌', '🌑'], color: '#7e22ce', adjectives: ADJ, artSrc: '/monsters/lich.jpg' },
  { id: 'shadow',          name: 'Тень',              icons: ['👤', '🖤', '🕶️', '🌑', '👁️', '🔮', '👑', '⚡', '🌌', '🪐'], color: '#334155', adjectives: ADJ, g: 'f', artSrc: '/monsters/ghost.jpg' },
  ...
  { id: 'leviathan',       name: 'Левиафан',          icons: ['🐋', '🌊', '⚡', '❄️', '💎', '🌌', '👑', '✨', '🪐', '🌑'], color: '#0f766e', adjectives: ADJ, artSrc: '/monsters/kraken.jpg' },
  { id: 'manticore',       name: 'Мантикора',         icons: ['🦁', '🦂', '🦅', '🔥', '☠️', '⚡', '👑', '💥', '🌌', '🌑'], color: '#d97706', adjectives: ADJ, g: 'f', artSrc: '/monsters/chimera.jpg' },
  ...
  { id: 'gorgon',          name: 'Горгона',           icons: ['🐍', '👁️', '🪨', '🏹', '🧪', '💀', '👑', '⚡', '💥', '🌑'], color: '#10b981', adjectives: ADJ, g: 'f', artSrc: '/monsters/snake.jpg' },
