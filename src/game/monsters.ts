...
export const FAMILIES: FamilyDef[] = [
  ...
  { id: 'elemental_storm', name: 'Элементаль бури',  icons: ['⚡', '🌩️', '🌪️', '💨', '☁️', '🔮', '👑', '🌟', '⚡', '🌑'], color: '#facc15', adjectives: ADJ, artSrc: '/monsters/storm_elemental.jpg' },
  { id: 'mushroom',        name: 'Гриб',              icons: ['🍄', '🌿', '🟤', '☠️', '💚', '🔮', '👑', '🧪', '✨', '🌑'], color: '#d946ef', adjectives: ADJ, artSrc: '/monsters/mushroom.jpg' },
  { id: 'crab',            name: 'Краб',              icons: ['🦀', '🦞', '🦐', '🌊', '🐚', '💎', '👑', '🫧', '🌊', '🌑'], color: '#fb7185', adjectives: ADJ, artSrc: '/monsters/crab.jpg' },
  { id: 'snake',           name: 'Змея',              icons: ['🐍', '🦎', '🥚', '☠️', '💚', '👁️', '👑', '🧪', '🩸', '🌑'], color: '#22c55e', adjectives: ADJ, g: 'f', artSrc: '/monsters/snake.jpg' },
  { id: 'scorpion',        name: 'Скорпион',          icons: ['🦂', '🏜️', '☠️', '🔥', '💛', '👁️', '👑', '⚡', '💥', '🌑'], color: '#eab308', adjectives: ADJ, artSrc: '/monsters/scorpion.jpg' },
  { id: 'harpy',           name: 'Гарпия',            icons: ['🦅', '🪶', '💨', '🌪️', '👁️', '⚡', '👑', '🌟', '✨', '🌑'], color: '#a3e635', adjectives: ADJ, g: 'f', artSrc: '/monsters/harpy.jpg' },
  ...
  { id: 'mage',            name: 'Тёмный маг',        icons: ['🧙', '🧙‍♂️', '🔮', '📖', '⚡', '💀', '👑', '🌌', '✨', '🌑'], color: '#8b5cf6', adjectives: ADJ, artSrc: '/monsters/dark_mage.jpg' },
  ...
  { id: 'wisp',            name: 'Дух',               icons: ['✨', '💫', '🌟', '🔆', '🕯️', '💀', '👑', '🌌', '⚡', '🌑'], color: '#fde68a', adjectives: ADJ, artSrc: '/monsters/wisp.jpg' },
  { id: 'construct',       name: 'Механизм',          icons: ['⚙️', '🤖', '🔩', '🛰️', '💣', '🔥', '👑', '⚡', '💥', '🌑'], color: '#94a3b8', adjectives: ADJ, artSrc: '/monsters/construct.jpg' },
  ...
  { id: 'siren',           name: 'Сирена',            icons: ['🧜‍♀️', '🐚', '🌊', '🔮', '🎵', '💫', '👑', '✨', '🌐', '🌑'], color: '#0284c7', adjectives: ADJ, g: 'f', artSrc: '/monsters/siren.jpg' },
  ...
  { id: 'necromancer',     name: 'Некромант',         icons: ['💀', '🧙‍♂️', '📜', '🕯️', '🩸', '🔮', '👑', '🟣', '🌌', '🌑'], color: '#7e22ce', adjectives: ADJ, artSrc: '/monsters/necromancer.jpg' },
  { id: 'shadow',          name: 'Тень',              icons: ['👤', '🖤', '🕶️', '🌑', '👁️', '🔮', '👑', '⚡', '🌌', '🪐'], color: '#334155', adjectives: ADJ, g: 'f', artSrc: '/monsters/shadow.jpg' },
  ...
  { id: 'leviathan',       name: 'Левиафан',          icons: ['🐋', '🌊', '⚡', '❄️', '💎', '🌌', '👑', '✨', '🪐', '🌑'], color: '#0f766e', adjectives: ADJ, artSrc: '/monsters/leviathan.jpg' },
  { id: 'manticore',       name: 'Мантикора',         icons: ['🦁', '🦂', '🦅', '🔥', '☠️', '⚡', '👑', '💥', '🌌', '🌑'], color: '#d97706', adjectives: ADJ, g: 'f', artSrc: '/monsters/manticore.jpg' },
  ...
  { id: 'gorgon',          name: 'Горгона',           icons: ['🐍', '👁️', '🪨', '🏹', '🧪', '💀', '👑', '⚡', '💥', '🌑'], color: '#10b981', adjectives: ADJ, g: 'f', artSrc: '/monsters/gorgon.jpg' },
  ...
  { id: 'yeti',            name: 'Йети',              icons: ['❄️', '🐾', '🧊', '🌨️', '⛄', '🏔️', '👑', '💎', '🌪️', '🌑'], color: '#7dd3fc', adjectives: ADJ, artSrc: '/monsters/yeti.jpg' },
];
...
export function makeMonster(familyId: string, tier: number, opts?: { boss?: boolean; mini?: boolean; name?: string; icon?: string }): MonsterDef {
  ...
  const tierMult = 1 + t * 0.45;
  const bossMult = isBoss ? 7.5 : isMini ? 3.0 : 1.2;
  ...
  } else if (mName.includes('Ифрит') || mName.includes('Магмус')) {
  ...
  } else if (mName.includes('Архидемон') || (isBoss && familyId === 'archdemon')) {
  ...
  } else if (mName.includes('Мантикора') || (isBoss && familyId === 'manticore')) {
    artSrc = '/monsters/manticore.jpg';
  } else if (mName.includes('Левиафан') || (isBoss && familyId === 'leviathan')) {
    artSrc = '/monsters/leviathan.jpg';
  } else if (mName.includes('Некромант') || (isBoss && familyId === 'necromancer')) {
    artSrc = '/monsters/necromancer.jpg';
  } else if (mName.includes('Король Слаймов') || (isBoss && familyId === 'slime')) {
    artSrc = '/monsters/slime_king.jpg';
  } else if (mName.includes('Владыка Скелетов') || (isBoss && familyId === 'skeleton')) {
    artSrc = '/monsters/skeleton_king.jpg';
  } else if (mName.includes('Титан') || mName.includes('Творец')) {
    artSrc = '/monsters/titan.jpg';
  } else if (familyId === 'yeti') {
  ...
  return {
    ...
    isBoss,
    isMiniBoss: isMini,
    hpMult: tierMult * bossMult * (isBoss ? 2.6 : 1.3),
    dmgMult: tierMult * (isBoss ? 2.2 : isMini ? 1.6 : 1.25),
    xpMult: tierMult * (isBoss ? 15 : isMini ? 5 : 1.2),
    goldMult: tierMult * (isBoss ? 18 : isMini ? 6 : 1.2),
    color: fam.color,
    artSrc,
  };
}
...
export const ZONES: ZoneDef[] = [
  {
    ...
    theme: { skyTop: '#7dd3fc', skyBottom: '#d9f99d', ground: '#4d7c0f', groundDark: '#3f6212', tiles: ['🌿', '🌱', '🍀', '🌼', '🌾'], particles: 'rgba(190,242,100,0.6)', fog: 'rgba(217,249,157,0.12)', artSrc: '/backgrounds/hills.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#0f2027', skyBottom: '#2c5364', ground: '#14532d', groundDark: '#052e16', tiles: ['🌲', '🌳', '🍂', '🍄', '🌫️'], particles: 'rgba(74,222,128,0.5)', fog: 'rgba(6,78,59,0.25)', artSrc: '/backgrounds/forest.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#1c1917', skyBottom: '#44403c', ground: '#57534e', groundDark: '#292524', tiles: ['⛏️', '🪨', '💎', '🕯️', '🛢️'], particles: 'rgba(251,191,36,0.5)', fog: 'rgba(68,64,60,0.3)', artSrc: '/backgrounds/mine.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#14532d', skyBottom: '#365314', ground: '#1a2e05', groundDark: '#0a1702', tiles: ['🌿', '🦠', '🫧', '🪷', '🐸'], particles: 'rgba(163,230,53,0.5)', fog: 'rgba(54,83,20,0.35)', artSrc: '/backgrounds/swamp.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#f59e0b', skyBottom: '#78350f', ground: '#d97706', groundDark: '#92400e', tiles: ['🌵', '🏜️', '🏺', '💀', '🌪️'], particles: 'rgba(253,224,71,0.6)', fog: 'rgba(245,158,11,0.2)', artSrc: '/backgrounds/desert.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#450a0a', skyBottom: '#7f1d1d', ground: '#991b1b', groundDark: '#450a0a', tiles: ['🌋', '🔥', '☄️', '💀', '💥'], particles: 'rgba(249,115,22,0.7)', fog: 'rgba(127,29,29,0.4)', artSrc: '/backgrounds/volcano.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#0c4a6e', skyBottom: '#0284c7', ground: '#e0f2fe', groundDark: '#7dd3fc', tiles: ['❄️', '🧊', '🌨️', '⛄', '💎'], particles: 'rgba(125,211,252,0.8)', fog: 'rgba(56,189,248,0.25)', artSrc: '/backgrounds/peaks.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#3b0764', skyBottom: '#581c87', ground: '#2e1065', groundDark: '#1e1b4b', tiles: ['🪦', '🕯️', '💀', '🔮', '📜'], particles: 'rgba(192,132,252,0.6)', fog: 'rgba(88,28,135,0.4)', artSrc: '/backgrounds/catacombs.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#1e1b4b', skyBottom: '#312e81', ground: '#1e293b', groundDark: '#0f172a', tiles: ['🏰', '⚔️', '🛡️', '🕯️', '👑'], particles: 'rgba(165,180,252,0.5)', fog: 'rgba(49,46,129,0.3)', artSrc: '/backgrounds/castle.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#0c4a6e', skyBottom: '#0369a1', ground: '#075985', groundDark: '#0c4a6e', tiles: ['🌊', '🐚', '⚓', '🫧', '💎'], particles: 'rgba(56,189,248,0.7)', fog: 'rgba(3,105,161,0.3)', artSrc: '/backgrounds/sea.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#4c1d95', skyBottom: '#6d28d9', ground: '#3b0764', groundDark: '#1e1b4b', tiles: ['✨', '💫', '🌟', '🔮', '🌀'], particles: 'rgba(232,121,249,0.8)', fog: 'rgba(109,40,217,0.35)', artSrc: '/backgrounds/astral.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#020617', skyBottom: '#0f172a', ground: '#1e1035', groundDark: '#090514', tiles: ['⚛️', '🪐', '🌌', '👁️', '☄️'], particles: 'rgba(192,132,252,0.9)', fog: 'rgba(15,23,42,0.5)', artSrc: '/backgrounds/abyss.jpg' },
  ...
  // 4 HIDDEN ZONES
  {
    ...
    theme: { skyTop: '#fbcfe8', skyBottom: '#f472b6', ground: '#15803d', groundDark: '#166534', tiles: ['🌺', '🌸', '🌼', '🦋', '✨'], particles: 'rgba(244,114,182,0.7)', fog: 'rgba(251,207,232,0.2)', artSrc: '/backgrounds/garden.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#78350f', skyBottom: '#b45309', ground: '#d97706', groundDark: '#78350f', tiles: ['🪙', '💰', '💎', '📦', '🔑'], particles: 'rgba(251,191,36,0.8)', fog: 'rgba(180,83,9,0.3)', artSrc: '/backgrounds/vault.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#312e81', skyBottom: '#4c1d95', ground: '#1e1b4b', groundDark: '#0f172a', tiles: ['🌀', '🖤', '⚡', '👁️', '🪐'], particles: 'rgba(168,85,247,0.8)', fog: 'rgba(76,29,149,0.4)', artSrc: '/backgrounds/grotto.jpg' },
  ...
  },
  {
    ...
    theme: { skyTop: '#fef08a', skyBottom: '#fde047', ground: '#ca8a04', groundDark: '#854d0e', tiles: ['👑', '⭐', '✨', '🗡️', '🛡️'], particles: 'rgba(253,224,71,0.9)', fog: 'rgba(254,240,138,0.25)', artSrc: '/backgrounds/throne.jpg' },
...
export const DUNGEONS: DungeonDef[] = [
  { id: 'd1', name: 'Склизкое Логово', icon: '🧪', minLevel: 5, waves: 5, familyPool: ['slime', 'rat', 'mushroom'], bossName: 'Король Слаймов', bossIcon: '👑', lootBonus: 1, rewardRarity: 'rare', xpMult: 2, goldMult: 2, desc: 'Первое испытание для начинающего искателя.' },
  { id: 'd2', name: 'Паучье Гнездо', icon: '🕷️', minLevel: 15, waves: 5, familyPool: ['spider', 'snake', 'scorpion'], bossName: 'Королева Арахнидов', bossIcon: '🕷️', lootBonus: 2, rewardRarity: 'rare', xpMult: 2.5, goldMult: 2.5, desc: 'Ядовитые тенета и орды маленьких паучат.' },
  { id: 'd3', name: 'Крипта Костей', icon: '💀', minLevel: 25, waves: 6, familyPool: ['skeleton', 'zombie', 'ghost'], bossName: 'Владыка Скелетов', bossIcon: '💀', lootBonus: 2, rewardRarity: 'epic', xpMult: 3, goldMult: 3, desc: 'Шорох костей в беззвучной мгле.' },
  { id: 'd4', name: 'Обитель Огня', icon: '🔥', minLevel: 40, waves: 6, familyPool: ['elemental_fire', 'demon', 'manticore'], bossName: 'Демонический Ифрит', bossIcon: '🔥', lootBonus: 3, rewardRarity: 'epic', xpMult: 3.5, goldMult: 3.5, desc: 'Печь Бездны, выжигающая слабых.' },
  { id: 'd5', name: 'Башня Мага', icon: '🔮', minLevel: 60, waves: 7, familyPool: ['mage', 'construct', 'wisp'], bossName: 'Тёмный Сумрачный Архимаг', bossIcon: '🧙‍♂️', lootBonus: 3, rewardRarity: 'legendary', xpMult: 4, goldMult: 4, desc: 'Магические ловушки и стихийные аномалии.' },
  { id: 'd6', name: 'Гробница Вампира', icon: '🦇', minLevel: 80, waves: 7, familyPool: ['vampire', 'cultist', 'knight'], bossName: 'Кровавый Дракула', bossIcon: '🧛‍♂️', lootBonus: 4, rewardRarity: 'legendary', xpMult: 5, goldMult: 5, desc: 'Древний склеп высшей аристократии ночи.' },
  { id: 'd7', name: 'Разлом Бездны', icon: '🌌', minLevel: 120, waves: 8, familyPool: ['abyss', 'lich', 'shadow'], bossName: 'Породитель Тьмы', bossIcon: '👁️', lootBonus: 5, rewardRarity: 'mythic', xpMult: 6, goldMult: 6, desc: 'Нестабильное измерение чистого хаоса.' },
  { id: 'd8', name: 'Святилище Богов', icon: '⚡', minLevel: 180, waves: 10, familyPool: ['dragon', 'phoenix', 'archdemon'], bossName: 'Верховный Титан', bossIcon: '🌟', lootBonus: 6, rewardRarity: 'mythic', xpMult: 8, goldMult: 8, desc: 'Финиширующее испытание величайших героев.' },
];
