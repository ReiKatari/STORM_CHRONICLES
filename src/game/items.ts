...
export const POTIONS_CATALOG: PotionItemDef[] = [
  { id: 'pot_hp_small', name: 'Малое Зелье Здоровья', icon: '🧪', rarity: 'common', desc: 'Мгновенно восстанавливает +200 HP.', sellPrice: 15 },
  { id: 'pot_hp_mid', name: 'Среднее Зелье Здоровья', icon: '🧪', rarity: 'uncommon', desc: 'Мгновенно восстанавливает +500 HP.', sellPrice: 35 },
  { id: 'pot_hp_grand', name: 'Великое Зелье Здоровья', icon: '🧪', rarity: 'rare', desc: 'Восстанавливает 100% HP и даёт +300 Силового Щита.', sellPrice: 85 },
  ...
  { id: 'pot_mana_grand', name: 'Астральный Эликсир Маны', icon: '🔮', rarity: 'rare', desc: 'Восстанавливает 100% Маны и сбрасывает КД всех скиллов.', sellPrice: 110 },
  { id: 'pot_berserk', name: 'Настойка Яростного Берсерка', icon: '🍷', rarity: 'rare', desc: '+35% Урона и +20% Крита на бой.', sellPrice: 150 },
  { id: 'pot_ironhide', name: 'Завар Твёрдой Стали', icon: '🛡️', rarity: 'uncommon', desc: '+50% Брони.', sellPrice: 90 },
  { id: 'pot_fortune', name: 'Зелье Удачной Зачистки', icon: '🍀', rarity: 'epic', desc: '+100% Золота и +75% Опыта со всех врагов.', sellPrice: 220 },
  ...
  { id: 'pot_astral', name: 'Катализатор Астральной Руды', icon: '💎', rarity: 'epic', desc: 'Синтезирует +15 ед. Астральной Руды.', sellPrice: 300 },
  { id: 'pot_titan', name: 'Эликсир Титанического Щита', icon: '🛡️', rarity: 'epic', desc: 'Накладывает +600 ед. Непробиваемого Астрального Щита.', sellPrice: 280 },
  { id: 'pot_rejuvenation', name: 'Эликсир Омоложения', icon: '✨', rarity: 'rare', desc: 'Восстанавливает 100% HP и 100% Маны.', sellPrice: 160 },
  { id: 'pot_vampirism', name: 'Тоник Вампиризма', icon: '🩸', rarity: 'rare', desc: '+20% Похищения Жизни (Лайфстил).', sellPrice: 140 },
  { id: 'pot_dragon_blood', name: 'Кровь Дракона', icon: '🔥', rarity: 'legendary', desc: '+50% Урона и поджигает все удары драконьим пламенем.', sellPrice: 450 },
  { id: 'pot_phoenix_tears', name: 'Слёзы Феникса', icon: '🪶', rarity: 'legendary', desc: 'Воскрешает с 100% HP при смертельном уроне.', sellPrice: 600 },
  { id: 'pot_shadow_brew', name: 'Теневая Выжимка', icon: '🌌', rarity: 'epic', desc: '+40% Дополнительного Урона из тени.', sellPrice: 250 },
  { id: 'pot_divine_nectar', name: 'Нектар Богов', icon: '👑', rarity: 'divine', desc: '+100% Всех характеристик и полное исцеление.', sellPrice: 1000 },
  { id: 'pot_golem_skin', name: 'Каменный Эликсир Голема', icon: '🗿', rarity: 'uncommon', desc: '+200 Брони и блокирует 15% урона.', sellPrice: 110 },
  { id: 'pot_arcane_surge', name: 'Всплеск Арканы', icon: '⚡', rarity: 'rare', desc: 'Сбрасывает манакост всех скиллов до 0.', sellPrice: 190 },
