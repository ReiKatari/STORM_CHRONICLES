...
export const QUESTS: QuestDef[] = [
  ...
  { id: 'q_ghost2', name: 'Изгнание теней', desc: 'Убейте 110 призраков', kind: 'kill', target: 'ghost', count: 110, reward: { gold: 3600, xp: 6200 } },
