...
<p align="center">
  <b>Интерактивный движок и визуализатор сюжетных хроник и визуальных новелл.</b>
</p>

[![Version](https://img.shields.io/badge/version-1.0.0-00D2FF.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_CHRONICLES)
[![Platform](https://img.shields.io/badge/Platform-Windows%2011%20%7C%2010-0EA5E9.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_CHRONICLES)
[![Tech](https://img.shields.io/badge/Tech-Vite+%2f+React+%2f+TailwindCSS-6366F1.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_CHRONICLES)
...
**STORM CHRONICLES** — компонент экосистемы **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
...
1. Запустите файл STORM_STORM_CHRONICLES_1.0.0_Setup.exe.
2. Выберите режим:
   * **Стандартная установка** — установка в C:\Program Files\STORM CHRONICLES с созданием ярлыков и регистрацией в системе.
